...
(function() {
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.neighbors = function(options) {
      var agent, neighbors, patch, square, _i, _j, _len, _len1, _ref1, _ref2;
      if (options == null) {
        options = 1;
      }
      if (options.radius) {
        ...
        if (this.patch) {
          _ref1 = this.patch.neighbors(options);
  ...
  ABM.Model = (function() {
    ...
    Model.prototype.setWorld = function(options) {
      ...
      for (key in worldDefaults) {
        if (!__hasProp.call(worldDefaults, key)) continue;
        value = worldDefaults[key];
        if (options[key] == null) {
          options[key] = value;
        }
      }
...
//# sourceMappingURL=agentbase.map
