...
(function() {
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.neighbors = function(options) {
      var agent, neighbors, patch, square, _i, _j, _len, _len1, _ref1, _ref2, _ref3;
      if (options == null) {
        options = 1;
      }
      if (options.radius) {
        ...
        if (this.patch) {
          _ref2 = this.patch.neighbors(options);
    ...
    Agent.prototype.die = function() {
      var link, _i, _len, _ref1, _step;
      this.breed.remove(this);
      _ref1 = this.links;
      for (_i = 0, _len = _ref1.length, _step = -1; _i < _len; _i += _step) {
        link = _ref1[_i];
        link.die();
      }
      this.moveOff();
    ...
    Agent.prototype.hatch = function(number, breed, init) {
      ...
      return breed.create(number, function(agent) {
        var key, value;
  ...
  ABM.Model = (function() {
    ...
    Model.prototype.setWorld = function(options) {
      var defaults, halfDiameter, key, shift, value, worldDefaults, _base1, _base2, _ref1, _ref2;
      defaults = {
        isHeadless: false,
        Agents: ABM.Agents,
        Agent: ABM.Agent,
      ...
      if ((_ref1 = (_base1 = this.world).min) == null) {
        _base1.min = {
          x: -1 * halfDiameter + shift,
          y: -1 * halfDiameter + shift
        };
      }
      if ((_ref2 = (_base2 = this.world).max) == null) {
        _base2.max = {
          x: halfDiameter,
          y: halfDiameter
        };
  ...
  ABM.Patches = (function(_super) {
    ...
    Patches.prototype.importDrawing = function(imageSrc, f) {
      var _this = this;
      return u.importImage(imageSrc, function(image) {
